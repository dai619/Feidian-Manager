  ...
  methods: {
    submitForm() {
      ...
      login(this.loginForm)
        .then((res) => {
          if (res.data.errno === 0) {
            _that.setAddress(this.loginForm.userEmail);
            _that.setUserLimit(res.data.data.userLimit);
            ...
            if (res.data.token) {
              ...
              _that.$store.commit(types.LOGIN, res.data.token);
